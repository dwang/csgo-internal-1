...
namespace cheat::core::menu {
	void menu_setup() {
		...
		ADD_WINDOW(container["#window"], 200, 200, "csgo-internal", 718, 454, fgui::external::KEY_INSERT, menu_font, false);
		...
		ADD_TAB(tabs["#tab_panel"], "G"); {
			...
			ADD_CHECKBOX(checkbox["#bunny_hop_checkbox"], 8, 14, "bunny hop", "vars.bunny_hop", menu_font, container["#main_groupbox"], 1);
