...
namespace fgui {
	...
	struct style {
		...
		*
		* std::array<fgui::color, 2> button = { fgui::color(74, 74, 74), fgui::color(36, 36, 36) };
		*
		...
		*/
		 ...
		 */
		 ...
		 // general
		std::array<fgui::color, 5> text = { fgui::color(255, 255, 255), fgui::color(255, 255, 255), fgui::color(255, 255, 255), fgui::color(255, 255, 255), fgui::color(255, 255, 255) };
		std::array<fgui::color, 2> cursor = { fgui::color(255, 255, 255), fgui::color(0, 0, 0) };
		std::array<fgui::color, 4> notifications = { fgui::color(28, 28, 28), fgui::color(40, 40, 40), fgui::color(40, 40, 40), fgui::color(48, 48, 48) };

		// elements
		std::array<fgui::color, 4> button = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 5> checkbox = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48), fgui::color(48, 48, 48) };
		std::array<fgui::color, 4> colorlist = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 4> colorpicker = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 4> combobox = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 3> container = { fgui::color(28, 28, 28), fgui::color(28, 28, 28), fgui::color(74, 74, 74) };
		std::array<fgui::color, 4> keybinder = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 6> label = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(181, 181, 181), fgui::color(48, 48, 48), fgui::color(156, 156, 156) };
		std::array<fgui::color, 4> listbox = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 4> multibox = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48) };
		std::array<fgui::color, 5> slider = { fgui::color(28, 28, 28), fgui::color(74, 74, 74), fgui::color(36, 36, 36), fgui::color(48, 48, 48), fgui::color(48, 48, 48) };
